...
@get_c_fun "libGL" wglsetstereoemitterstate3dl wglSetStereoEmitterState3DL glSetStereoEmitterState3DL(hDC::HDC, uState::UINT)::Int32
export wglsetstereoemitterstate3dl
@get_c_fun "libGL" wglgetgpuidsamd wglGetGPUIDsAMD glGetGPUIDsAMD(maxCount::UINT, ids::Ptr{UINT})::uInt32
export wglgetgpuidsamd
@get_c_fun "libGL" wglgetgpuinfoamd wglGetGPUInfoAMD glGetGPUInfoAMD(id::UINT, property::Int, dataType::GLenum, size::UINT, data::Ptr{Void})::int32
export wglgetgpuinfoamd
@get_c_fun "libGL" wglgetcontextgpuidamd wglGetContextGPUIDAMD glGetContextGPUIDAMD(hglrc::HGLRC)::uInt32
...
@get_c_fun "libGL" wglcreateassociatedcontextattribsamd wglCreateAssociatedContextAttribsAMD glCreateAssociatedContextAttribsAMD(id::UINT, hShareContext::HGLRC, attribList::Ptr{Int})::Ptr{Void}
export wglcreateassociatedcontextattribsamd
@get_c_fun "libGL" wgldeleteassociatedcontextamd wglDeleteAssociatedContextAMD glDeleteAssociatedContextAMD(hglrc::HGLRC)::Int32
export wgldeleteassociatedcontextamd
@get_c_fun "libGL" wglmakeassociatedcontextcurrentamd wglMakeAssociatedContextCurrentAMD glMakeAssociatedContextCurrentAMD(hglrc::HGLRC)::Int32
...
@get_c_fun "libGL" wglcreatebufferregionarb wglCreateBufferRegionARB glCreateBufferRegionARB(hDC::HDC, iLayerPlane::Int, uType::UINT)::Ptr{Void}
export wglcreatebufferregionarb
@get_c_fun "libGL" wglsavebufferregionarb wglSaveBufferRegionARB glSaveBufferRegionARB(hRegion::HANDLE, x::Int, y::int, width::int, height::int)::int32
export wglsavebufferregionarb
@get_c_fun "libGL" wglrestorebufferregionarb wglRestoreBufferRegionARB glRestoreBufferRegionARB(hRegion::HANDLE, x::Int, y::int, width::int, height::int, xSrc::int, ySrc::int)::int32
export wglrestorebufferregionarb
@get_c_fun "libGL" wglcreatecontextattribsarb wglCreateContextAttribsARB glCreateContextAttribsARB(hDC::HDC, hShareContext::HGLRC, attribList::Ptr{Int})::Ptr{Void}
...
@get_c_fun "libGL" wglmakecontextcurrentarb wglMakeContextCurrentARB glMakeContextCurrentARB(hDrawDC::HDC, hReadDC::HDC, hglrc::HGLRC)::Int32
...
@get_c_fun "libGL" wglcreatepbufferarb wglCreatePbufferARB glCreatePbufferARB(hDC::HDC, iPixelFormat::Int, iWidth::int, iHeight::int, piAttribList::Ptr{int})::Ptr{Void}
...
@get_c_fun "libGL" wgldestroypbufferarb wglDestroyPbufferARB glDestroyPbufferARB(hPbuffer::HPBUFFERARB)::Int32
export wgldestroypbufferarb
@get_c_fun "libGL" wglquerypbufferarb wglQueryPbufferARB glQueryPbufferARB(hPbuffer::HPBUFFERARB, iAttribute::Int, piValue::Ptr{int})::int32
export wglquerypbufferarb
@get_c_fun "libGL" wglgetpixelformatattribivarb wglGetPixelFormatAttribivARB glGetPixelFormatAttribivARB(hdc::HDC, iPixelFormat::Int, iLayerPlane::int, nAttributes::UINT, piAttributes::Ptr{int}, piValues::Ptr{int})::int32
export wglgetpixelformatattribivarb
@get_c_fun "libGL" wglgetpixelformatattribfvarb wglGetPixelFormatAttribfvARB glGetPixelFormatAttribfvARB(hdc::HDC, iPixelFormat::Int, iLayerPlane::int, nAttributes::UINT, piAttributes::Ptr{int}, pfValues::Ptr{FLOAT})::int32
export wglgetpixelformatattribfvarb
@get_c_fun "libGL" wglchoosepixelformatarb wglChoosePixelFormatARB glChoosePixelFormatARB(hdc::HDC, piAttribIList::Ptr{Int}, pfAttribFList::Ptr{FLOAT}, nMaxFormats::UINT, piFormats::Ptr{int}, nNumFormats::Ptr{UINT})::int32
export wglchoosepixelformatarb
@get_c_fun "libGL" wglbindteximagearb wglBindTexImageARB glBindTexImageARB(hPbuffer::HPBUFFERARB, iBuffer::Int)::int32
export wglbindteximagearb
@get_c_fun "libGL" wglreleaseteximagearb wglReleaseTexImageARB glReleaseTexImageARB(hPbuffer::HPBUFFERARB, iBuffer::Int)::int32
export wglreleaseteximagearb
@get_c_fun "libGL" wglsetpbufferattribarb wglSetPbufferAttribARB glSetPbufferAttribARB(hPbuffer::HPBUFFERARB, piAttribList::Ptr{Int})::int32
...
@get_c_fun "libGL" wglloaddisplaycolortableext wglLoadDisplayColorTableEXT glLoadDisplayColorTableEXT(table::Ptr{GLushort}, length::GLuInt)::Bool
...
@get_c_fun "libGL" wglmakecontextcurrentext wglMakeContextCurrentEXT glMakeContextCurrentEXT(hDrawDC::HDC, hReadDC::HDC, hglrc::HGLRC)::Int32
...
@get_c_fun "libGL" wglcreatepbufferext wglCreatePbufferEXT glCreatePbufferEXT(hDC::HDC, iPixelFormat::Int, iWidth::int, iHeight::int, piAttribList::Ptr{int})::Ptr{Void}
...
@get_c_fun "libGL" wgldestroypbufferext wglDestroyPbufferEXT glDestroyPbufferEXT(hPbuffer::HPBUFFEREXT)::Int32
export wgldestroypbufferext
@get_c_fun "libGL" wglquerypbufferext wglQueryPbufferEXT glQueryPbufferEXT(hPbuffer::HPBUFFEREXT, iAttribute::Int, piValue::Ptr{int})::int32
export wglquerypbufferext
@get_c_fun "libGL" wglgetpixelformatattribivext wglGetPixelFormatAttribivEXT glGetPixelFormatAttribivEXT(hdc::HDC, iPixelFormat::Int, iLayerPlane::int, nAttributes::UINT, piAttributes::Ptr{int}, piValues::Ptr{int})::int32
export wglgetpixelformatattribivext
@get_c_fun "libGL" wglgetpixelformatattribfvext wglGetPixelFormatAttribfvEXT glGetPixelFormatAttribfvEXT(hdc::HDC, iPixelFormat::Int, iLayerPlane::int, nAttributes::UINT, piAttributes::Ptr{int}, pfValues::Ptr{FLOAT})::int32
export wglgetpixelformatattribfvext
@get_c_fun "libGL" wglchoosepixelformatext wglChoosePixelFormatEXT glChoosePixelFormatEXT(hdc::HDC, piAttribIList::Ptr{Int}, pfAttribFList::Ptr{FLOAT}, nMaxFormats::UINT, piFormats::Ptr{int}, nNumFormats::Ptr{UINT})::int32
export wglchoosepixelformatext
@get_c_fun "libGL" wglswapIntervalext wglSwapIntervalEXT glSwapIntervalEXT(interval::int)::int32
export wglswapIntervalext
@get_c_fun "libGL" wglgetswapIntervalext wglGetSwapIntervalEXT glGetSwapIntervalEXT()::Int
export wglgetswapIntervalext
@get_c_fun "libGL" wglgetdigitalvideoparametersi3d wglGetDigitalVideoParametersI3D glGetDigitalVideoParametersI3D(hDC::HDC, iAttribute::Int, piValue::Ptr{int})::int32
export wglgetdigitalvideoparametersi3d
@get_c_fun "libGL" wglsetdigitalvideoparametersi3d wglSetDigitalVideoParametersI3D glSetDigitalVideoParametersI3D(hDC::HDC, iAttribute::Int, piValue::Ptr{int})::int32
export wglsetdigitalvideoparametersi3d
@get_c_fun "libGL" wglgetgammatableparametersi3d wglGetGammaTableParametersI3D glGetGammaTableParametersI3D(hDC::HDC, iAttribute::Int, piValue::Ptr{int})::int32
export wglgetgammatableparametersi3d
@get_c_fun "libGL" wglsetgammatableparametersi3d wglSetGammaTableParametersI3D glSetGammaTableParametersI3D(hDC::HDC, iAttribute::Int, piValue::Ptr{int})::int32
export wglsetgammatableparametersi3d
@get_c_fun "libGL" wglgetgammatablei3d wglGetGammaTableI3D glGetGammaTableI3D(hDC::HDC, iEntries::Int, puRed::Ptr{USHORT}, puGreen::Ptr{USHORT}, puBlue::Ptr{USHORT})::int32
export wglgetgammatablei3d
@get_c_fun "libGL" wglsetgammatablei3d wglSetGammaTableI3D glSetGammaTableI3D(hDC::HDC, iEntries::Int, puRed::Ptr{USHORT}, puGreen::Ptr{USHORT}, puBlue::Ptr{USHORT})::int32
export wglsetgammatablei3d
@get_c_fun "libGL" wglenablegenlocki3d wglEnableGenlockI3D glEnableGenlockI3D(hDC::HDC)::Int32
export wglenablegenlocki3d
@get_c_fun "libGL" wgldisablegenlocki3d wglDisableGenlockI3D glDisableGenlockI3D(hDC::HDC)::Int32
export wgldisablegenlocki3d
@get_c_fun "libGL" wglisenabledgenlocki3d wglIsEnabledGenlockI3D glIsEnabledGenlockI3D(hDC::HDC, pFlag::Ptr{BOOL})::Int32
export wglisenabledgenlocki3d
@get_c_fun "libGL" wglgenlocksourcei3d wglGenlockSourceI3D glGenlockSourceI3D(hDC::HDC, uSource::UINT)::Int32
export wglgenlocksourcei3d
@get_c_fun "libGL" wglgetgenlocksourcei3d wglGetGenlockSourceI3D glGetGenlockSourceI3D(hDC::HDC, uSource::Ptr{UINT})::Int32
export wglgetgenlocksourcei3d
@get_c_fun "libGL" wglgenlocksourceedgei3d wglGenlockSourceEdgeI3D glGenlockSourceEdgeI3D(hDC::HDC, uEdge::UINT)::Int32
export wglgenlocksourceedgei3d
@get_c_fun "libGL" wglgetgenlocksourceedgei3d wglGetGenlockSourceEdgeI3D glGetGenlockSourceEdgeI3D(hDC::HDC, uEdge::Ptr{UINT})::Int32
export wglgetgenlocksourceedgei3d
@get_c_fun "libGL" wglgenlocksampleratei3d wglGenlockSampleRateI3D glGenlockSampleRateI3D(hDC::HDC, uRate::UINT)::Int32
export wglgenlocksampleratei3d
@get_c_fun "libGL" wglgetgenlocksampleratei3d wglGetGenlockSampleRateI3D glGetGenlockSampleRateI3D(hDC::HDC, uRate::Ptr{UINT})::Int32
export wglgetgenlocksampleratei3d
@get_c_fun "libGL" wglgenlocksourcedelayi3d wglGenlockSourceDelayI3D glGenlockSourceDelayI3D(hDC::HDC, uDelay::UINT)::Int32
export wglgenlocksourcedelayi3d
@get_c_fun "libGL" wglgetgenlocksourcedelayi3d wglGetGenlockSourceDelayI3D glGetGenlockSourceDelayI3D(hDC::HDC, uDelay::Ptr{UINT})::Int32
export wglgetgenlocksourcedelayi3d
@get_c_fun "libGL" wglquerygenlockmaxsourcedelayi3d wglQueryGenlockMaxSourceDelayI3D glQueryGenlockMaxSourceDelayI3D(hDC::HDC, uMaxLineDelay::Ptr{UINT}, uMaxPixelDelay::Ptr{UINT})::Int32
...
@get_c_fun "libGL" wgldestroyimagebufferi3d wglDestroyImageBufferI3D glDestroyImageBufferI3D(hDC::HDC, pAddress::LPVOID)::Int32
export wgldestroyimagebufferi3d
@get_c_fun "libGL" wglassociateimagebuffereventsi3d wglAssociateImageBufferEventsI3D glAssociateImageBufferEventsI3D(hDC::HDC, pEvent::HANDLE, pAddress::LPVOID, pSize::Ptr{DWORD}, count::UINT)::Int32
export wglassociateimagebuffereventsi3d
@get_c_fun "libGL" wglreleaseimagebuffereventsi3d wglReleaseImageBufferEventsI3D glReleaseImageBufferEventsI3D(hDC::HDC, pAddress::LPVOID, count::UINT)::Int32
export wglreleaseimagebuffereventsi3d
@get_c_fun "libGL" wglenableframelocki3d wglEnableFrameLockI3D glEnableFrameLockI3D()::Int32
export wglenableframelocki3d
@get_c_fun "libGL" wgldisableframelocki3d wglDisableFrameLockI3D glDisableFrameLockI3D()::Int32
export wgldisableframelocki3d
@get_c_fun "libGL" wglisenabledframelocki3d wglIsEnabledFrameLockI3D glIsEnabledFrameLockI3D(pFlag::Ptr{BOOL})::Int32
export wglisenabledframelocki3d
@get_c_fun "libGL" wglqueryframelockmasteri3d wglQueryFrameLockMasterI3D glQueryFrameLockMasterI3D(pFlag::Ptr{BOOL})::Int32
export wglqueryframelockmasteri3d
@get_c_fun "libGL" wglgetframeusagei3d wglGetFrameUsageI3D glGetFrameUsageI3D((*C.float32)(pUsage))::Int32
export wglgetframeusagei3d
@get_c_fun "libGL" wglbeginframetrackingi3d wglBeginFrameTrackingI3D glBeginFrameTrackingI3D()::Int32
export wglbeginframetrackingi3d
@get_c_fun "libGL" wglendframetrackingi3d wglEndFrameTrackingI3D glEndFrameTrackingI3D()::Int32
export wglendframetrackingi3d
@get_c_fun "libGL" wglqueryframetrackingi3d wglQueryFrameTrackingI3D glQueryFrameTrackingI3D(pFrameCount::Ptr{DWORD}, pMissedFrames::Ptr{DWORD}, (*C.float32)(pLastMissedUsage))::Int32
export wglqueryframetrackingi3d
@get_c_fun "libGL" wgldxsetresourcesharehandlenv wglDXSetResourceShareHandleNV glDXSetResourceShareHandleNV(dxObject::Ptr{Void}, shareHandle::HANDLE)::Int32
...
@get_c_fun "libGL" wgldxclosedevicenv wglDXCloseDeviceNV glDXCloseDeviceNV(hDevice::HANDLE)::Int32
export wgldxclosedevicenv
@get_c_fun "libGL" wgldxregisterobjectnv wglDXRegisterObjectNV glDXRegisterObjectNV(hDevice::HANDLE, dxObject::Ptr{Void}, name::GLuInt, type_::GLenum, access::GLenum)::Ptr{Void}
export wgldxregisterobjectnv
@get_c_fun "libGL" wgldxunregisterobjectnv wglDXUnregisterObjectNV glDXUnregisterObjectNV(hDevice::HANDLE, hObject::HANDLE)::Int32
export wgldxunregisterobjectnv
@get_c_fun "libGL" wgldxobjectaccessnv wglDXObjectAccessNV glDXObjectAccessNV(hObject::HANDLE, access::GLenum)::Int32
export wgldxobjectaccessnv
@get_c_fun "libGL" wgldxlockobjectsnv wglDXLockObjectsNV glDXLockObjectsNV(hDevice::HANDLE, count::GLInt, hObjects::HANDLE)::int32
export wgldxlockobjectsnv
@get_c_fun "libGL" wgldxunlockobjectsnv wglDXUnlockObjectsNV glDXUnlockObjectsNV(hDevice::HANDLE, count::GLInt, hObjects::HANDLE)::int32
export wgldxunlockobjectsnv
@get_c_fun "libGL" wglcopyimagesubdatanv wglCopyImageSubDataNV glCopyImageSubDataNV(hSrcRC::HGLRC, srcName::GLuInt, srcTarget::GLenum, srcLevel::GLint, srcX::GLint, srcY::GLint, srcZ::GLint, hDstRC::HGLRC, dstName::GLUint, dstTarget::GLenum, dstLevel::GLint, dstX::GLint, dstY::GLint, dstZ::GLint, width::GLsizei, height::GLsizei, depth::GLsizei)::int32
export wglcopyimagesubdatanv
@get_c_fun "libGL" wglenumgpusnv wglIntGpusNV glEnumGpusNV(iGpuIndex::UINT, phGpu::HGPUNV)::Int32
export wglenumgpusnv
@get_c_fun "libGL" wglenumgpudevicesnv wglIntGpuDevicesNV glEnumGpuDevicesNV(hGpu::HGPUNV, iDeviceIndex::UINT, (C.PGPU_DEVICE)(lpGpuDevice))::Int32
...
@get_c_fun "libGL" wglenumgpusfromaffinitydcnv wglIntGpusFromAffinityDCNV glEnumGpusFromAffinityDCNV(hAffinityDC::HDC, iGpuIndex::UINT, hGpu::HGPUNV)::Int32
export wglenumgpusfromaffinitydcnv
@get_c_fun "libGL" wgldeletedcnv wglDeleteDCNV glDeleteDCNV(hdc::HDC)::Int32
export wgldeletedcnv
@get_c_fun "libGL" wglenumeratevideodevicesnv wglInterateVideoDevicesNV glEnumerateVideoDevicesNV(hDC::HDC, phDeviceList::HVIDEOOUTPUTDEVICENV)::Int
export wglenumeratevideodevicesnv
@get_c_fun "libGL" wglbindvideodevicenv wglBindVideoDeviceNV glBindVideoDeviceNV(hDC::HDC, (C.uInt32)(uVideoSlot), hVideoDevice::HVIDEOOUTPUTDEVICENV, piAttribList::Ptr{int})::int32
export wglbindvideodevicenv
@get_c_fun "libGL" wglquerycurrentcontextnv wglQueryCurrentContextNV glQueryCurrentContextNV(iAttribute::Int, piValue::Ptr{int})::int32
export wglquerycurrentcontextnv
@get_c_fun "libGL" wgljoinswapgroupnv wglJoinSwapGroupNV glJoinSwapGroupNV(hDC::HDC, group::GLuInt)::int32
export wgljoinswapgroupnv
@get_c_fun "libGL" wglbindswapbarriernv wglBindSwapBarrierNV glBindSwapBarrierNV(group::GLuInt, barrier::GLUint)::int32
export wglbindswapbarriernv
@get_c_fun "libGL" wglqueryswapgroupnv wglQuerySwapGroupNV glQuerySwapGroupNV(hDC::HDC, group::Ptr{GLuInt}, barrier::Ptr{GLUint})::int32
export wglqueryswapgroupnv
@get_c_fun "libGL" wglquerymaxswapgroupsnv wglQueryMaxSwapGroupsNV glQueryMaxSwapGroupsNV(hDC::HDC, maxGroups::Ptr{GLuInt}, maxBarriers::Ptr{GLUint})::int32
export wglquerymaxswapgroupsnv
@get_c_fun "libGL" wglqueryframecountnv wglQueryFrameCountNV glQueryFrameCountNV(hDC::HDC, count::Ptr{GLuInt})::int32
export wglqueryframecountnv
@get_c_fun "libGL" wglresetframecountnv wglResetFrameCountNV glResetFrameCountNV(hDC::HDC)::Int32
...
@get_c_fun "libGL" wglbindvideocapturedevicenv wglBindVideoCaptureDeviceNV glBindVideoCaptureDeviceNV(uVideoSlot::UINT, hDevice::HVIDEOINPUTDEVICENV)::Int32
export wglbindvideocapturedevicenv
@get_c_fun "libGL" wglenumeratevideocapturedevicesnv wglInterateVideoCaptureDevicesNV glEnumerateVideoCaptureDevicesNV(hDc::HDC, phDeviceList::HVIDEOINPUTDEVICENV)::uInt32
export wglenumeratevideocapturedevicesnv
@get_c_fun "libGL" wgllockvideocapturedevicenv wglLockVideoCaptureDeviceNV glLockVideoCaptureDeviceNV(hDc::HDC, hDevice::HVIDEOINPUTDEVICENV)::Int32
export wgllockvideocapturedevicenv
@get_c_fun "libGL" wglqueryvideocapturedevicenv wglQueryVideoCaptureDeviceNV glQueryVideoCaptureDeviceNV(hDc::HDC, hDevice::HVIDEOINPUTDEVICENV, iAttribute::Int, piValue::Ptr{int})::int32
export wglqueryvideocapturedevicenv
@get_c_fun "libGL" wglreleasevideocapturedevicenv wglReleaseVideoCaptureDeviceNV glReleaseVideoCaptureDeviceNV(hDc::HDC, hDevice::HVIDEOINPUTDEVICENV)::Int32
export wglreleasevideocapturedevicenv
@get_c_fun "libGL" wglgetvideodevicenv wglGetVideoDeviceNV glGetVideoDeviceNV(hDC::HDC, numDevices::Int, hVideoDevice::HPVIDEODEV)::int32
export wglgetvideodevicenv
@get_c_fun "libGL" wglreleasevideodevicenv wglReleaseVideoDeviceNV glReleaseVideoDeviceNV(hVideoDevice::HPVIDEODEV)::Int32
export wglreleasevideodevicenv
@get_c_fun "libGL" wglbindvideoimagenv wglBindVideoImageNV glBindVideoImageNV(hVideoDevice::HPVIDEODEV, hPbuffer::HPBUFFERARB, iVideoBuffer::Int)::int32
export wglbindvideoimagenv
@get_c_fun "libGL" wglreleasevideoimagenv wglReleaseVideoImageNV glReleaseVideoImageNV(hPbuffer::HPBUFFERARB, iVideoBuffer::Int)::int32
export wglreleasevideoimagenv
@get_c_fun "libGL" wglsendpbuffertovideonv wglSendPbufferToVideoNV glSendPbufferToVideoNV(hPbuffer::HPBUFFERARB, iBufferType::Int, (*C.unsigned_long)(pulCounterPbuffer), bBlock::BOOL)::int32
export wglsendpbuffertovideonv
@get_c_fun "libGL" wglgetvideoinfonv wglGetVideoInfoNV glGetVideoInfoNV(hpVideoDevice::HPVIDEODEV, (*C.unsigned_long)(pulCounterOutputPbuffer), (*C.unsigned_long)(pulCounterOutputVideo))::Int32
export wglgetvideoinfonv
@get_c_fun "libGL" wglgetsyncvaluesoml wglGetSyncValuesOML glGetSyncValuesOML(hdc::HDC, (*C.INT64)(ust), (*C.INT64)(msc), (*C.INT64)(sbc))::Int32
export wglgetsyncvaluesoml
@get_c_fun "libGL" wglgetmscrateoml wglGetMscRateOML glGetMscRateOML(hdc::HDC, (*C.INT32)(numerator), (*C.INT32)(denominator))::Int32
export wglgetmscrateoml
@get_c_fun "libGL" wglswapbuffersmscoml wglSwapBuffersMscOML glSwapBuffersMscOML(hdc::HDC, (C.INT64)(target_msc), (C.INT64)(divisor), (C.INT64)(remainder))::Int64
export wglswapbuffersmscoml
@get_c_fun "libGL" wglswaplayerbuffersmscoml wglSwapLayerBuffersMscOML glSwapLayerBuffersMscOML(hdc::HDC, fuPlanes::Int, (C.INT64)(target_msc), (C.INT64)(divisor), (C.INT64)(remainder))::Int64
export wglswaplayerbuffersmscoml
@get_c_fun "libGL" wglwaitformscoml wglWaitForMscOML glWaitForMscOML(hdc::HDC, (C.INT64)(target_msc), (C.INT64)(divisor), (C.INT64)(remainder), (*C.INT64)(ust), (*C.INT64)(msc), (*C.INT64)(sbc))::Int32
export wglwaitformscoml
@get_c_fun "libGL" wglwaitforsbcoml wglWaitForSbcOML glWaitForSbcOML(hdc::HDC, (C.INT64)(target_sbc), (*C.INT64)(ust), (*C.INT64)(msc), (*C.INT64)(sbc))::Int32
...
@get_c_fun "libGL" wgldeletecontext wglDeleteContext glDeleteContext(oldContext::HGLRC)::Int32
...
@get_c_fun "libGL" wglmakecurrent wglMakeCurrent glMakeCurrent(hDc::HDC, newContext::HGLRC)::Int32
export wglmakecurrent
@get_c_fun "libGL" wglcopycontext wglCopyContext glCopyContext(hglrcSrc::HGLRC, hglrcDst::HGLRC, mask::UINT)::Int32
...
@get_c_fun "libGL" wglsetpixelformat wglSetPixelFormat glSetPixelFormat(hdc::HDC, ipfd::Int, ppfd::PIXELFORMATDESCRIPTOR)::int32
export wglsetpixelformat
@get_c_fun "libGL" wglswapbuffers wglSwapBuffers glSwapBuffers(hdc::HDC)::Int32
export wglswapbuffers
@get_c_fun "libGL" wglsharelists wglShareLists glShareLists(hrcSrvShare::HGLRC, hrcSrvSource::HGLRC)::Int32
export wglsharelists
@get_c_fun "libGL" wglcreatelayercontext wglCreateLayerContext glCreateLayerContext(hDc::HDC, level::Int)::Ptr{Void}
export wglcreatelayercontext
@get_c_fun "libGL" wgldescribelayerplane wglDescribeLayerPlane glDescribeLayerPlane(hDc::HDC, pixelFormat::Int, layerPlane::int, nBytes::UINT, plpd::LAYERPLANEDESCRIPTOR)::int32
export wgldescribelayerplane
@get_c_fun "libGL" wglsetlayerpaletteentries wglSetLayerPaletteEntries glSetLayerPaletteEntries(hdc::HDC, iLayerPlane::Int, iStart::int, cEntries::int, pcr::COLORREF)::Int
export wglsetlayerpaletteentries
@get_c_fun "libGL" wglgetlayerpaletteentries wglGetLayerPaletteEntries glGetLayerPaletteEntries(hdc::HDC, iLayerPlane::Int, iStart::int, cEntries::int, pcr::COLORREF)::Int
export wglgetlayerpaletteentries
@get_c_fun "libGL" wglrealizelayerpalette wglRealizeLayerPalette glRealizeLayerPalette(hdc::HDC, iLayerPlane::Int, bRealize::BOOL)::int32
export wglrealizelayerpalette
@get_c_fun "libGL" wglswaplayerbuffers wglSwapLayerBuffers glSwapLayerBuffers(hdc::HDC, fuFlags::UINT)::Int32
export wglswaplayerbuffers
@get_c_fun "libGL" wglusefontbitmapsa wglUseFontBitmapsA glUseFontBitmapsA(hDC::HDC, first::DWORD, count::DWORD, listBase::DWORD)::Int32
export wglusefontbitmapsa
@get_c_fun "libGL" wglusefontbitmapsw wglUseFontBitmapsW glUseFontBitmapsW(hDC::HDC, first::DWORD, count::DWORD, listBase::DWORD)::Int32
